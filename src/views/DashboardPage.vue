    ...
    <main class="container mx-auto py-6 px-4">
      ...
      <div class="mb-6 bg-white p-6 rounded-lg shadow-md">
        ...
        <p class="text-gray-600 mb-4">
          People who might be perfect collaborators for you
        </p>
          ...
          >
            ...
            <div class="mb-3">
              ...
              <div class="flex flex-wrap gap-1">
                ...
                <span
                  v-if="match.complementarySkills.length > 2"
                  class="text-xs text-gray-500"
                >
      ...
      <div class="mb-6 bg-white p-6 rounded-lg shadow-md">
        ...
        <div
          v-if="bestProjectMatches.length > 0"
          class="grid grid-cols-1 md:grid-cols-3 gap-4"
        >
          <div 
        ...
        >
          <p class="text-gray-500">
            No matching projects found. Add more skills to your profile to find suitable projects!
          </p>
          <button 
            class="mt-3 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm"
            @click="editProfile"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
          ...
          <div
            v-if="currentUser && currentUser.projects && currentUser.projects.length > 0"
            class="mb-6"
          >
          ...
          <div>
            ...
            <div class="space-y-2">
              ...
              <div class="border border-gray-200 p-3 rounded bg-blue-50">
                ...
                <p class="text-sm text-gray-600">
                  Looking for developers with interest in sustainable solutions
                </p>
              ...
              <div class="border border-gray-200 p-3 rounded">
                ...
                <p class="text-sm text-gray-600">
                  Connect with junior developers as a mentor
                </p>
                <div class="mt-2 flex justify-end">
                  <button class="text-blue-600 hover:text-blue-800 text-sm">
                    Learn More
