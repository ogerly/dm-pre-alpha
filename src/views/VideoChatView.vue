      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-2">
          <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div
              class="video-container bg-black rounded-lg overflow-hidden"
              style="height: 400px;"
            >
              <div
                v-if="!isConnected"
              ...
              >
                <div class="text-center">
                  ...
                  <p class="text-gray-400">
                    Start a video chat by connecting with a user
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div class="w-full h-full bg-gray-800 flex items-center justify-center">
                  <p class="text-white">
                    Remote video would appear here
                  </p>
                </div>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <div class="space-y-2 max-h-60 overflow-y-auto">
              <div
                ...
                :key="user.id"
                class="border border-gray-200 p-2 rounded flex justify-between items-center"
              >
                <div>
