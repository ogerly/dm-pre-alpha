    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="stat-card bg-purple-50 border-l-4 border-purple-500 p-4 rounded-md">
          <h3 class="text-purple-700 text-lg font-medium">
            Aktivität
          </h3>
          <p class="text-3xl font-bold">
            {{ activeUsers }}
        ...
        <div class="flex justify-between items-center mb-4">
          ...
          <div class="flex gap-2">
            ...
            <button class="bg-primary text-white py-2 px-4 rounded text-sm">
              <i class="fas fa-plus mr-1" /> Benutzer hinzufügen
            </button>
          </div>
        </div>
        ...
        >
          <div class="border border-gray-200 rounded-md p-4">
            ...
            <div class="form-group mt-4">
              ...
              <p class="text-xs text-gray-500 mt-1">
                Im Wartungsmodus ist die Plattform nur für Admins zugänglich.
              </p>
            </div>
          </div>
            ...
            <div class="form-group mt-4">
              ...
              >
                <input
                  ...
                  v-model="systemSettings.approvalRequired"
                  type="checkbox"
                  class="mr-2"
                >
          ...
          <div class="border border-gray-200 rounded-md p-4">
            ...
            <div class="space-y-3">
              <button
                type="button"
                class="bg-indigo-50 text-indigo-700 py-2 px-4 rounded hover:bg-indigo-100 transition-colors"
                @click="backupDatabase"
              >
                <i class="fas fa-database mr-2" /> Datenbank sichern
              </button>
              
              <button
                type="button"
                class="bg-red-50 text-red-700 py-2 px-4 rounded hover:bg-red-100 transition-colors"
                @click="showResetModal = true"
              >
                <i class="fas fa-redo-alt mr-2" /> Zurücksetzen
              </button>
            </div>
          </div>
          ...
          <div class="text-right">
            <button
              type="submit"
              class="bg-primary text-white py-2 px-6 rounded hover:bg-indigo-600 transition-colors"
            >
      ...
      >
        ...
        <div class="bg-gray-50 p-4 rounded-md mb-6">
          ...
          <div class="h-48 flex items-center justify-center bg-gray-100 rounded">
            <p class="text-gray-500">
              Chart: Benutzeraktivität der letzten 30 Tage
            </p>
          </div>
        </div>
        ...
        <div class="bg-gray-50 p-4 rounded-md">
          ...
          <div class="space-y-2">
            <div
              v-for="(user, index) in mostActiveUsers"
              :key="index"
