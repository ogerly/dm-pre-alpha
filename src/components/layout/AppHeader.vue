  ...
  <header class="bg-white shadow dark:bg-gray-800">
    <div class="container mx-auto px-4 py-4">
      ...
      <div class="flex justify-between items-center mb-2">
        ...
        <div class="flex items-center space-x-4">
          <span
            ...
            class="text-gray-600 hidden md:inline dark:text-gray-300"
          >
      ...
      <div
        ...
        class="md:hidden mt-2 bg-gray-50 rounded-md p-2 dark:bg-gray-700"
      >
        <router-link 
          v-for="navItem in navigationItems" 
          :key="navItem.path" 
...
<script>
import { defineComponent, ref } from 'vue' // Remove computed from the import
